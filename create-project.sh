...
echo "=============================================="
echo ""
echo "  Your project has a local git repo initialized."
echo "  To push your work to GitHub:"
echo ""
echo "  Option 1 - Create repo manually:"
...
echo "    gh repo create my-project --private --source=. --remote=origin --push"
echo ""
echo "=============================================="
echo ""
